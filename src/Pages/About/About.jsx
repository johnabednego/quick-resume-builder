...
const testimonials = [
    {
        ...
        avatar:
            'https://abednegoportfolio.netlify.app/assets/images/profile-lg.jpg',
    }
];
...
export default function About() {
    return (
        <>
            <Helmet>
                <title>About Us - Quick Resume Builder</title>
                ...
                <meta property="og:description" content="Learn more about the Quick Resume Builder website and its mission to provide easy-to-use tools for creating professional resumes." />
                <meta property="og:image" content="https://abednegoportfolio.netlify.app/assets/images/profile-lg.jpg" />
